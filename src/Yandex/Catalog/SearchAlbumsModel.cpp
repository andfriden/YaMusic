...
SearchAlbumsModel::SearchAlbumsModel(
    QObject *parent)
    : QAbstractListModel(parent)
{
}

int SearchAlbumsModel::rowCount(
...
QVariant SearchAlbumsModel::data(
...
SearchAlbumsModel::roleNames() const
{
    return {
        {IdRole, "albumId"},
        {TitleRole, "title"},
...
void SearchAlbumsModel::setAlbums(
...
Album SearchAlbumsModel::albumAt(
    int index) const
{
    if (
        index < 0 ||
