...
SearchPlaylistsModel::SearchPlaylistsModel(
    QObject *parent)
    : QAbstractListModel(parent)
{
}

int SearchPlaylistsModel::rowCount(
...
QVariant SearchPlaylistsModel::data(
...
SearchPlaylistsModel::roleNames() const
{
    return {
        {
            IdRole,
...
void SearchPlaylistsModel::setPlaylists(
...
PersonalPlaylist
SearchPlaylistsModel::playlistAt(
    int index) const
{
    if (
        index < 0 ||
