...
/*
 * Страница исполнителя: шапка, популярные треки, последний релиз
 * и сетка всех альбомов.
 */
Item {
    id: root
    ...
    // Контент
    //
    // Вложенного ScrollView нет: вертикальным скроллом владеет
    // внешний ScrollView в MainLayout. Вложенный ScrollView заглотил
    // бы колесо мыши и заблокировал прокрутку страницы.
    // -------------------------------------------------------------
    ...
    Column {
        ...
        // ---------------------------------------------------------
        // Популярные треки + последний релиз
        // ---------------------------------------------------------
        ...
        // Нижний отступ (внутри Column, поэтому скроллится вместе
        // с контентом)
        Item {
            width: 1
            height: 140
