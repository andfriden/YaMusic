...
Item {
    ...
    TextField {
        ...
        background: Rectangle {
            ...
            color: searchField.activeFocus ? AppTheme.panelActive : AppTheme.panelSubtle
        ...
        Text {
            ...
            text: "⌕"
            color: searchField.activeFocus ? AppTheme.textPrimary : AppTheme.textMuted
            font.pixelSize: 23
